...
echo @color("nevy","\n╔════════════════•ೋೋ•════════════════╗\n");
echo @color("red","        TEMBAK PAKET THREE BOSKU\n");
echo @color("green","          FB REAL OKI FAJRI\n");
echo @color("white","      ____________________________");
echo @color("yellow","\n•••BILANG OKI F.A TAMPAN  DULU DEK •••");
echo @color("nevy","\n╚════════════════•ೋೋ•════════════════╝\n\n");
echo @color('purple',"[●] NOMOR REAL BY FB OKI FAJRI\t: ");
$nomor = trim(fgets(STDIN));
$login = login($nomor);
echo @color('grey', $login['message']."\n");
echo @color('purple', "[☆] OTP NYA SAYANG\t\t: ");
...
if (strpos(json_encode($login), '"status":true')) {
    ...
    echo @color('purple', "BONSTRI\t\t: ");
    echo @color('blue', "$poin Poin\n");
    cek:
    echo @color("nevy","\n╔════════════════꧁ঔৣ☬⫸༒⫷☬ঔৣ꧂════════════════╗\n");
    echo @color('green', "\nSILAHKAN DIPILIH PAKETNYA BY FB OKI FAJRI  :\n");
    echo @color('yellow', "
